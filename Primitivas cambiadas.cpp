...
void balanceodeCarga(TareaIA *&inicio, TareaIA *&listaSecundaria){
    TareaIA *actual = inicio;
    float umbral;
    float total = 0;
    TareaIA *ordenada = nullptr;
    ...
    cout << "Se han eliminado los elementos de la lista principal y quedaria: " << endl;
    mostrarLista(inicio);
    cout << "Y en la lista secundaria estan: " << endl;
    mostrarLista(listaSecundaria);
    
    // CORRECCIÓN: SE ELIMINÓ EL BUCLE 'while (listaSecundaria != nullptr) { delete ... }'
    // Ahora los datos se quedan guardados en la memoria de la lista secundaria.
}
...
int main(){
    ...
    TareaIA *listaSecundaria = nullptr; // CORRECCIÓN: Tercera lista persistente
    ...
    cargarDesdeArchivo(listaSecundaria, "Lista_secundaria.txt");
    while (x != 11){
        system("cls");
        ...
        cout << " 5. Imprimir la lista secundaria (Espera LEO)" << endl; // CORRECCIÓN: Nueva opción para la defensa
        cout << " 6. Ordenar la lista en funcion del consumo energetico" << endl;
        cout << " 7. Eliminar nodos que supere un dato determinado de latencia" << endl;
        cout << " 8. Procesar cuantas tareas antes de agotar la bateria" << endl;
        cout << " 9. Mover tareas de menor urgencia a una lista de espera" << endl;
        cout << " 10. Eliminar peor eficiencia" << endl;
        ...
        switch(x)
        {
            case 1:
                ...
                guardarEnArchivo(listaSecundaria, "Lista_secundaria.txt"); // CORRECCIÓN
                break;
            case 2:
            ...
            case 4:
                ...
                break;
            case 5: // CORRECCIÓN: Mostrar la lista secundaria
                if (listaVacia(listaSecundaria)) cout << "La lista secundaria esta vacia." << endl;
                else { cout << "La lista secundaria es: " << endl; mostrarLista(listaSecundaria); }
                break;
            case 6:
                menorMayor(lista);
                break;
            ...
            case 8:
                ...
                break;
            case 9:
                balanceodeCarga(lista, listaSecundaria); // CORRECCIÓN: Pasar por referencia
                break;
            case 10:
